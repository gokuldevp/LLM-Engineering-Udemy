...
This module is based on the Day 2 homework solution and can be
imported from other code or run directly as a small CLI.
"""
...
and provides a detailed, smart, summary, ignoring text that might be navigation related.
...
def main():
    """Main entry point for testing from the command line."""
